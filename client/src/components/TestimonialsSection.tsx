  ...
  return (
    <section id="testimonials" className="py-24 bg-secondary/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2-column grid — rapih, kompak di mobile */}
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          {TESTIMONIALS.map((t, i) => (
            <motion.div
              ...
              className="relative bg-white dark:bg-card rounded-2xl p-3 sm:p-5 border border-border/50 shadow-sm"
            >
              <Quote className="absolute top-3 right-3 w-4 h-4 text-primary/10" />
              {/* Header */}
              <div className="flex items-center gap-2 mb-2">
                <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs shrink-0">
                ...
                <div className="shrink-0 bg-secondary/60 rounded-full p-1 sm:px-1.5 sm:py-0.5 flex items-center gap-0.5">
                  <GoogleLogo />
                </div>
              </div>
              {/* Stars */}
